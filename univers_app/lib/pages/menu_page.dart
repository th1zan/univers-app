...
import 'package:univers_app/globals/lock_texts.dart';
...
class MenuPage extends StatelessWidget {
            ...
            child: SafeArea(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildSoundSection(context, lang),
                    const SizedBox(height: 20.0),
                    _buildLanguageSection(context, lang),
                    const SizedBox(height: 20.0),
                    _buildLockSection(context, lang),
                    const SizedBox(height: 20.0),
                  ],
                ),
              ),
  ...
  Widget _buildSoundSection(BuildContext context, String lang) {
    return _buildCard(
      icon: Icons.volume_up_rounded,
      iconColor: const Color(0xFF4ECDC4),
      title: soundSectionTexts[lang] ?? 'Sound',
          ...
          return Column(
            children: [
              _buildSwitchTile(
                ...
                label: backgroundMusicTexts[lang] ?? 'Background Music',
              ...
              _buildSwitchTile(
                ...
                label: textToSpeechTexts[lang] ?? 'Text to Speech',
  ...
  Widget _buildLanguageSection(BuildContext context, String lang) {
    return _buildCard(
      icon: Icons.language_rounded,
      iconColor: const Color(0xFFFFD93D),
      title: languageSectionTexts[lang] ?? 'Language',
      child: Consumer<AppState>(
        builder: (context, appState, child) {
          return Container(
                  ...
                  return DropdownMenuItem(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          appState.languageNames[langCode] ?? langCode.toUpperCase(),
                        ),
                      ],
                    ),
                  );
  ...
  Widget _buildLockSection(BuildContext context, String lang) {
    return _buildCard(
      icon: Icons.lock_rounded,
      iconColor: const Color(0xFFFF6B9D),
      title: lockSectionTexts[lang] ?? 'Guided Access',
      child: Consumer<AppState>(
        builder: (context, appState, child) {
          return Column(
            children: [
              _buildLockInstruction(
                platform: 'iOS',
                icon: Icons.apple,
                text: iosLockTexts[appState.selectedLanguage] ?? 
              ...
              _buildLockInstruction(
                ...
                text: androidLockTexts[appState.selectedLanguage] ?? 
