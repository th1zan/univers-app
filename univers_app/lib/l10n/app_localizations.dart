...
abstract class AppLocalizations {
  ...
  /// Titre de la section verrouillage parental
  ///
  /// In fr, this message translates to:
  /// **'Verrouillage guidé'**
  String get guidedAccessSection;
  ...
  /// Texte par défaut pour un élément sans titre
  ///
  /// In fr, this message translates to:
  /// **'Sans titre'**
  String get untitled;

  /// Instructions pour activer le verrouillage guidé sur iOS
  ///
  /// In fr, this message translates to:
  ...
  /// Instructions pour activer le verrouillage guidé sur Android
  ///
  /// In fr, this message translates to:
